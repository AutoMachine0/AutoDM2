...
def cross_validation_graph():

    seed_list = [1, 12, 55, 78, 99, 123, 543, 666, 777, 12345]
    # seed_list = [2, 432, 524, 15, 13451, 879, 58, 642401, 454169, 510154]
    graph_list = []

    for seed in seed_list:
        graph_list.append(Glgcan(seed))

    return graph_list

if __name__=="__main__":

    graph_list = cross_validation_graph()
    pass